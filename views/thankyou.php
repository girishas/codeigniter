        ...
        <div class="col-md-6">
            <div class="thank-outer">
                ...
                <div class="text-center">
                      <h4>Hi <?=$data['admin_name']?></h4>
                      <p>We have sent a confirmation link on <b><?=$data['email']?></b>, Please confirm your identity in order to access your account.<br>Thank You</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
