	    	...
	    	<div class="page-main">
				...
				<div class="panel">
					...
					<div class="panel-heading">
			            <h1 class="panel-title">Manage Permission</h1>
										...
										<td>
											<div class="btn-group dropdown">
													...
													<div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
														<a href="javascript:void(0);" onClick="operation_staff('<?php echo $row['id']; ?>','active')" class="dropdown-item" title="Active"><i class="icon md-check" aria-hidden="true"></i> Active</a>
														<a href="javascript:void(0);" onClick="operation_staff('<?php echo $row['id']; ?>','inactive')" class="dropdown-item" title="Active"><i class="icon md-pause" aria-hidden="true"></i> Inactive</a>
