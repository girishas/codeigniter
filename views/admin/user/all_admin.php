			...
			<div class="panel">
				...
				<div class="page-main">
					...
					<div class="page-header">
						...
						<!-- <div class="page-header-actions"><a href="<?php echo base_url('admin/user/add_admin');?>"><button type="button" class="btn btn-block btn-primary">Add Admin User</button></a></div> -->
