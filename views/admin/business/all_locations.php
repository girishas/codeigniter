	...
	<div class="page">
		...
		<div class="page-content">
			...
			<div class="panel-heading">
				<h1 class="panel-title"><?php if(isset($business_detail[0]['name']) && $business_detail[0]['name']!='') echo $business_detail[0]['name']." >> locations"; else echo "All Locations"; ?></h1>
				<div class="page-header-actions">
					<a class="btn btn-info" href="<?php echo base_url('admin/business/add_location');?>"> Add Location </a>
							...
							<td >
								<div class="btn-group dropdown">
									...
									<div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
										...
										<a class="dropdown-item" href="<?php echo base_url('admin/business/edit_location/'.$row['id']);?>" role="menuitem"><i class="icon md-edit" aria-hidden="true"></i>Edit</a>
...
function operations(id,op_type)
{
	if(id!="" && op_type!=""){
		swal({
			...
			$.ajax({
				type: 'POST',
				url: site_url + 'admin/Operations/operation_location/' + encodeURIComponent(id),
