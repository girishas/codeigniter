...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Calendar | Booking in time</title>
	...
	<link rel="stylesheet" href="<?php echo base_url('global/vendor/fullcalendar/fullcalendar.css');?>">
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/examples/css/apps/calendar.css');?>">
