				...
				<div class="panel">
					...
					<div class="page-header">
						...
						<div class="page-header-actions">
							<a class="btn btn-info" href="<?php echo base_url('admin/expense/add_pos_category');?>">Add Category</a>
						</div>
					<?php } ?>
					</div>
					...
					<div id="contactsContent" class="page-content page-content-table" data-plugin="selectable">
						<?php if(isset($all_service_category)){?>
												...
												<td>
													<div class="btn-group dropdown">
														...
														<div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
															<a class="dropdown-item" href="<?php echo base_url('admin/expense/edit_pos_category/'.$row['id']);?>" role="menuitem"><i class="icon md-edit" aria-hidden="true"></i>Edit</a>
							...
							<?php }else{?>
							<div style="width:100%;float:left;text-align:center;">No Pos Category Added Yet</div>
						<?php }?>
