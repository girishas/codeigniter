 ...
 <!-- Page -->
    <div class="page">
        ...
        <div class="page-header-actions"><a href="<?php echo base_url('admin/service');?>"><button type="button" class="btn btn-block btn-primary">All Services</button></a></div>
          ...
          <?php $this->load->view('admin/common/expense_menu'); ?>
	      	<div class="page-header-actions">
	        	<a class="btn btn-info" href="<?php echo base_url('admin/expense/all_pos_category');?>">All Category</a>
	      	</div>
	    </div>		
      ...
      <div class="page-content container-fluid">
      	...
      	<div class="row">
      		<div class="col-md-6">
      			<h1 class="page-title">Edit Pos Category</h1><hr>
      		</div>
      	</div>
          ...
          <div class="col-md-6">
            ...
            <div class="panel">
              ...
              <div class="panel-body container-fluid">
            	...
            	<form autocomplete="off" method="post" action="<?php echo base_url('admin/expense/edit_pos_category/'.$this->uri->segment('4')); ?>">

            		<input type="hidden" name="edit_pos_category" value="edit_pos_category">
        			...
        			<div class="form-group  row" data-plugin="formMaterial">
					  <div class="col-md-12">
						  	...
						  	<?php $business_id = (isset($business_id) && $business_id!='')?$business_id:$pos_category_details[0]['business_id'];?>
                  	...
                  	<div class="form-group  row" data-plugin="formMaterial">
				  		<div class="col-md-12">
						  	...
						  	<?php $name = (isset($name) && $name!='')?$name:$pos_category_details[0]['name'];?>
