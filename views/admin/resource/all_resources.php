...
<body class="animsition app-contacts page-aside-left">
  ...
  <div class="page">
                ...
                <table id="example" class="table table-hover  table-striped w-full" data-plugin="">
                  <thead>
                    <tr>
                      ...
                      <th class="dark-background-heading">Resource Name</th>
                  ...
                  <tbody>
                    ...
                    <tr id="row_<?php echo $row['id']; ?>">
                      ...
                      <td>
                        <a href="<?php echo base_url('admin/resource/edit_resource/'.$row['id']);?>"><?php echo $row['resource_name'];?></a>
                      </td>
                      
                      <td>
                        <a href="<?php echo base_url('admin/resource/edit_resource/'.$row['id']);?>"><?php echo $row['quantity'];?></a>
                      </td>
                      ...
                      <td>
                        <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
                            <a class="dropdown-item" href="<?php echo base_url('admin/resource/edit_resource/'.$row['id']);?>" role="menuitem"><i class="icon md-edit" aria-hidden="true"></i>Edit</a>
    ...
    function operation_resources(id) {
        if (id != "") {
        swal({
        title: "Are you sure?",
        type: "info",
        ...
        //closeOnCancel: false
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url("admin/Operations/delete_resource/")?>' + encodeURIComponent(id),
                    datatype: 'json',
                    beforeSend: function() {},
