                    ...
                    <tbody>
                      ...
                      <tr id="row_<?php echo $row['id']; ?>">
                        ...
                        <td><?php echo $row['invoice_number'];?></td>
                          ...
                          <td><?php $cust_name = getCustomerNameById($row['customer_id']); if(!empty($cust_name)) { echo $cust_name; } ?></td>
                          <td><?php echo $loc_name = getLocationNameById($row['location_id']);//$loc_name = getLocationNameById($row['location_id']); if(!empty($loc_name)) { echo $loc_name; } ?></td>
                          ...
                          <td>
                            <div class="btn-group dropdown">
                              ...
                              <div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
                                ...
                                <a class="dropdown-item" href="<?php //echo base_url('admin/invoice/edit_invoice/'.$row['id']);?>" role="menuitem"><i class="icon md-edit" aria-hidden="true"></i>Edit</a>
...
<script language="javascript">
  ...
  if(id!="" && op_type!=""){
    swal({
       ...
       $.ajax({
        type: 'POST',
        url: site_url + 'admin/Operations/delete_invoices/' + encodeURIComponent(id),
