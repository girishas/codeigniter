        ...
        <div class="col-md-12">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title">Edit Vouchers</h3>
            </div>
              ...
              <form autocomplete="off" method="post" action="?php echo  base_url('admin/voucher/edit_voucher'); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group  row" data-plugin="formMaterial">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="vouchar_name" name="vouchar_name" value="<?php if(isset($vouchar_name)) { echo $vouchar_name; }?>" />
                ...
                <div class="form-group  row" data-plugin="formMaterial">
                  ...
                  <div class="col-md-6">
					...
					<input type="text" class="form-control" id="voucher_amount" name="voucher_amount" value="<?php if(isset($voucher_amount)) { echo $voucher_amount; }?>" />
