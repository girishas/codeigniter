<tr class="remove_<?=$count;?>">
	<td>
		<select name="service_group[<?=$count?>][id]" required="required" class="form-control select selectd_item" data-plugin="select2" onchange="getPackageData(this.value,<?=$count?>)">
    ...
    <td><input type="text" onchange="changeUnitPrice(this.value,<?=$count?>)" class="form-control unit_price_<?=$count?>" min="1" value="0" name="service_group[<?=$count?>][unit_price]" value=""></td>
    ...
    <td><input type="text" onchange="calculateTotalPrice()" name="service_group[<?=$count?>][total_price]" class="form-control total_price_<?=$count?> total_amount" value="0" name="total_price"></td>
