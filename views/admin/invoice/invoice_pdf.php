                ...
                <div class="page-content">
                    <div class="panel">
                        ...
                        <?php endif ?>
                         <div style="text-align:center;">
                            <h2>
                            <?php echo getBusinessNameById($invoice_data['business_id']); ?>
                            </h2>
                        </div>
                            <div class="row">
                               <div class="col-md-12">
                                     <?php $businessDetails= getBusinessData($invoice_data['business_id']); ?>
                      ABN No. : <?php echo $businessDetails['abn_number'] ;

                        ?>  </div>  
                         <div class="col-md-12">
                                     <?php $locationDetails= getLocationData($invoice_data['location_id']); ?>
                       Address. : <?php echo $locationDetails['address1'] ;
                        ...
                        ?>  </div>  
                                ...
                                <div class="col-md-12">
                                   Invoice To : <?= getCustomerNameById($invoice_data['customer_id']) ?>
                                </div>
                                <!-- <div class="col-md-6"> -->
                                     <div class="col-md-12">
                                   Tax Invoice #<?=$invoice_data['invoice_number'];?>
                                </div>
                                    <div class="col-md-12">
                                        Invoice Date:
                            ...
                            <div class="row">
                                <table class="table">
                                    <thead>
                                        <tr>
                                           <!--  <th class="text-center"><b class="black">Staff</b></th> -->
                                            <th class="text-center"><b class="black">Item</b></th>
                                            <th class="text-center"><b class="black">Qty</b></th>
                                            <th class="text-center"><b class="black">Price</b></th>
                                            <!-- <th class="text-center"><b class="black">Tax</b></th> -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <!-- <td><span class="badge badge-round badge-dark"><?=getStaffName($value['staff_id'])?></span></td> -->
                                            ...
                                            <?=$value['service_unit_price']?></td>
                                          <!--   <td class="text-right"><?=$value['tax_amount']?></td> -->
                                            <td class="text-right">
                                                <?php echo ($value['pay_service_type']==7 or $value['pay_service_type']==8)?"-":""; ?>
                                                <?=$value['service_total_price']?>
                                            </td>
                                        </tr>
                                        <?php endforeach ?>
                                        <tr>
                                            
                                            <td class="text-right" colspan="3"><b>Inc. Tax</b></td>
                                            <td class="text-right"><b>$<?= $invoice_data['tax_price']; ?></b></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right" colspan="3"><b>Amt. Paid</b></td>
                                            <td class="text-right"><b><?php  
                                          $total_price=  $invoice_data['total_price']-$invoice_data['outstanding_invoice_amount'];

                                            echo '$'.$total_price; ?></b></td>
                                        </tr>
                                        <tr>
                                            
                                            <td class="text-right" colspan="3"><b>Amt. Due</b></td>
                                            <td class="text-right"><b>$<?= ($invoice_data['outstanding_invoice_amount']>0)?$invoice_data['outstanding_invoice_amount']:0; ?></b></td>
                                        </tr>
                            ...
                            <div class="row">
                                <?php if(!empty($invoice_payments[0]['paid_amount'])):
                                ?>
                                <h3 class="black" style="width: 100%;">Payment</h3>
                                <ul>
                                    <?php foreach ($invoice_payments as $key => $value): ?>
                                    <li class="black"><?=date("D, d M Y",strtotime($value['paid_date']));?>&nbsp;|&nbsp;<?=$value['paid_amount']?>&nbsp;|&nbsp;<?=getPayType($value['payment_type_id'])?></li>
                                    <?php endforeach ?>
                                </ul>
                                <?php endif ?>
                            </div>
