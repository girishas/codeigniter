 ...
 <div class="page bg-white">
      ...
      <div class="page-main">
        ...
        <div class="page-header">
          <h1 class="page-title"><?php echo $staff_name; ?>  >> Assigned Services</h1>
          <div class="page-header-actions"><a href="<?php echo base_url('admin/staff/assign_new_service?staff='.$staff_name);?>"><button type="button" class="btn btn-block btn-primary">Assign New Service</button></a></div>
	    </div>
          ...
          <table class="table is-indent" data-plugin="animateList" data-animate="fade" data-child="tr"data-selectable="selectable">
            <thead>
              <tr>
				...
				<th class="cell-40 dark-background-heading" scope="col">Assigned date</th>
            ...
            <tbody>
              <tr>
               ...
               <td class="cell-40" scope="col">2018-04-22 20:42:03</td>
              ...
              <tr>
                ...
                <td class="cell-100">Hair Color</td>				
                <td class="cell-40" scope="col">2018-04-22 20:42:03</td>
				<td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                     <button type="button" class="btn btn-default dropdown-toggle" id="exampleColorDropdown1" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Hair Textures</td>
				<td class="cell-40" scope="col">2018-04-22 20:42:03</td>
				<td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                     <button type="button" class="btn btn-default dropdown-toggle" id="exampleColorDropdown1" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Hair Blowouts</td>				
                <td class="cell-40" scope="col">2018-04-22 20:42:03</td>
				<td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-default dropdown-toggle" id="exampleColorDropdown1" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
               ...
               <td class="cell-100">Hair Styling</td>				
                <td class="cell-40" scope="col">2018-04-22 20:42:03</td>
				<td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-default dropdown-toggle" id="exampleColorDropdown1" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Body Facial</td>				
                <td class="cell-40" scope="col">2018-04-22 20:42:03</td>
				<td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-default dropdown-toggle" id="exampleColorDropdown1" data-toggle="dropdown" aria-expanded="false">Actions</button>
