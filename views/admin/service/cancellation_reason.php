 ...
 <div class="page bg-white">
      ...
      <div class="page-main">
        ...
        <div class="page-header">
          <h1 class="page-title">Appointment Cancellation Reasons</h1>
		  <div class="page-header-actions"><a href="<?php echo base_url('admin/service/add_cancellation_reason');?>"><button type="button" class="btn btn-block btn-primary">Add Cancellation Reason</button></a></div>
        </div>
          ...
          <table class="table is-indent" data-plugin="animateList" data-animate="fade" data-child="tr"
            ...
            <thead>
              <tr>
                ...
                <th class="cell-100 dark-background-heading" scope="col">Reason Name</th>
            ...
            <tbody>
              <tr>
                ...
                <td class="cell-100">Did not specify</td>
              ...
              <tr>
                ...
                <td class="cell-100">Other committments</td>
				<td class="cell-100">2018-04-22 20:42:03</td>
                <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                     <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Not necessary now</td>
				<td class="cell-100">2018-04-22 20:42:03</td>
                <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                     <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Did not show</td>
				<td class="cell-100">2018-04-22 20:42:03</td>
               <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
			   ...
			   <tr>
                ...
                <td class="cell-100">Appointment made in error</td>
				<td class="cell-100">2018-04-22 20:42:03</td>
               <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
