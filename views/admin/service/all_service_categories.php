				...
				<div class="panel">
					...
					<div class="page-header">
						...
						<div class="page-header-actions">
							<a class="btn btn-info" href="<?php echo base_url('admin/service/add_service_category');?>">Add Service Category</a>
						</div>
					<?php } ?>
					</div>
					...
					<div id="contactsContent" class="page-content page-content-table" data-plugin="selectable">
						<?php if(isset($all_service_category)){?>
							<!-- Actions -->
							...
							<form id="frm_records" name="frm_records" action="" method="post">
								<table id="example" class="table table-hover  table-striped w-full" data-plugin="">
									...
									<tbody>
										...
										<?php $counter = 1;foreach($all_service_category as $row){?>
												...
												<td>
													<div class="btn-group dropdown">
														...
														<div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
															<a class="dropdown-item" href="<?php echo base_url('admin/service/edit_service_category/'.$row['id']);?>" role="menuitem"><i class="icon md-edit" aria-hidden="true"></i>Edit</a>
	...
	<script language="javascript">
		...
		function operation_service_category (id) {
			...
			swal({
				...
				$.ajax({
					type: 'POST',
					url: site_url + 'admin/Operations/delete_service_category/' + encodeURIComponent(id),
