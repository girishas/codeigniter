 ...
 <div class="page bg-white">
      ...
      <div class="page-main">
        ...
        <div class="page-header">
          <h1 class="page-title">Appointment Colors</h1>
		  <div class="page-header-actions"><a href="<?php echo base_url('admin/service/add_appointment_color');?>"><button type="button" class="btn btn-block btn-primary">Add Appointment Color</button></a></div>
        </div>
          ...
          <table class="table is-indent" data-plugin="animateList" data-animate="fade" data-child="tr"
            ...
            <thead>
              <tr>
                ...
                <th class="cell-100 dark-background-heading" scope="col">Color Name</th>
				<th class="cell-100 dark-background-heading" scope="col">Color Code</th>
				<th class="cell-30 dark-background-heading" scope="col">Color</th>
            ...
            <tbody>
              <tr>
                ...
                <td class="cell-100">Red</td>
				<td class="cell-100">#FF0000</td>
				<td class="cell-100"><div style="width:70px;height:25px;background:#FF0000"></div></td>
              ...
              <tr>
                ...
                <td class="cell-100">Maroon</td>
				<td class="cell-100">#800000</td>
				<td class="cell-100"><div style="width:70px;height:25px;background:#800000"></div></td>
				<td class="cell-100">2018-04-22 20:42:03</td>
                <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                     <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Yellow</td>
				<td class="cell-100">#FFFF00</td>
				<td class="cell-100"><div style="width:70px;height:25px;background:#FFFF00"></div></td>
				<td class="cell-100">2018-04-22 20:42:03</td>
                <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                     <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Olive</td>
				<td class="cell-100">#808000</td>
				<td class="cell-100"><div style="width:70px;height:25px;background:#808000"></div></td>
				<td class="cell-100">2018-04-22 20:42:03</td>
               <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Green</td>
				<td class="cell-100">#008000</td>
				<td class="cell-100"><div style="width:70px;height:25px;background:#008000"></div></td>
				<td class="cell-100">2018-04-22 20:42:03</td>
                <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
              ...
              <tr>
                ...
                <td class="cell-100">Navy</td>
				<td class="cell-100">#000080</td>
				<td class="cell-100"><div style="width:70px;height:25px;background:#000080"></div></td>
				<td class="cell-100">2018-04-22 20:42:03</td>
                <td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Actions</button>
