 ...
 <div class="page bg-white">
      ...
      <div class="page-main">
        ...
        <div class="page-header">
          <h1 class="page-title">All Service Groups Treatement Type</h1>
		  <div class="page-header-actions"><a href="<?php echo base_url('admin/service/add_service_treatment_type');?>"><button type="button" class="btn btn-block btn-primary">Add Treatment Type</button></a>
		  </div>
	    </div>
          ...
          <table class="table is-indent" data-plugin="animateList" data-animate="fade" data-child="tr"
            ...
            <thead>
              <tr>
                ...
                <th class="cell-100 dark-background-heading" scope="col">Treatement Name</th>				
					...
					<div class="btn-group dropdown">
                     <button type="button" class="btn btn-default dropdown-toggle" id="exampleColorDropdown1" data-toggle="dropdown" aria-expanded="false">Actions</button>
                      <div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">Active</a>
                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">Inactive</a>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="cell-100">Blowouts</td>
				<td class="cell-100">2018-04-22 20:42:03</td>
				<td class="cell-30" scope="col"><span class="badge badge-danger">Inactive</span></td>
				<td class="cell-50" scope="col">
					<div class="btn-group dropdown">
                      <button type="button" class="btn btn-default dropdown-toggle" id="exampleColorDropdown1" data-toggle="dropdown" aria-expanded="false">Actions</button>
                      <div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
			  ...
			  <tr>
                ...
                <td class="cell-100">Hair Removal and Brows </td>
				<td class="cell-100">2018-04-22 20:42:03</td>
				<td class="cell-30" scope="col"><span class="badge badge-danger">Inactive</span></td>
				<td class="cell-50" scope="col">
					<div class="btn-group dropdown">
