				...
				<div class="panel">
					...
					<div class="page-header">
						...
						<div class="page-header-actions">
							<a class="btn btn-info" href="<?php echo base_url('admin/service/add_service_group');?>">Add Service Group</a>
						</div>
					<?php } ?>
					</div>
					...
					<div id="contactsContent" class="page-content page-content-table" data-plugin="selectable">
						<?php if(isset($all_service_group)){?>
							<!-- Actions -->
								...
								<table id="example" class="table table-hover  table-striped w-full" data-plugin="">
									<thead>
										<tr>
											...
											<th class="cell-10 dark-background-heading" scope="col">Service Group Name</th>
												<th class="cell-10 dark-background-heading" scope="col">SKU</th>
												<th class="cell-10 dark-background-heading" scope="col">Sequence Order</th>
									...
									<tbody>
										...
										<?php $counter = 1;foreach($all_service_group as $row){?>
											...
											<!-- 	<td><?=$counter;?></td> -->
												...
												<td><?php echo $row['sequenceo_order'];?></td>
												...
												<td>
													<div class="btn-group dropdown">
														...
														<div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
															...
															<?php if($admin_session['role']=='owner' or $admin_session['role']=='business_owner'){ ?>
															<a class="dropdown-item" href="<?php echo base_url('admin/service/add_service_group/'.$row['id']);?>" role="menuitem"><i class="icon md-edit" aria-hidden="true"></i>Edit</a>
															<a class="dropdown-item" href="javascript:void(0)" onClick="operation_service_group('<?php echo $row['id']; ?>','delete')" role="menuitem"><i class="icon md-delete" aria-hidden="true"></i>Delete</a>
														<?php } ?>
														<a class="dropdown-item" href="<?php echo base_url('admin/service/service_group_view/'.$row['id']);?>" role="menuitem"><i class="icon md-eye" aria-hidden="true"></i>View</a>
														</div>
													</div>
												</td>
							...
							<?php }else{?>
							<div style="width:100%;float:left;text-align:center;">No Service Group Added</div>
						<?php }?>
	...
	<script language="javascript">
		...
		$jq(document).ready(function(){
			...
			if(id !=""){
				$.ajax({
				type: 'POST',
				url: site_url + 'admin/invoice/get_service_group/' + encodeURIComponent(id),
				datatype: 'json',
				beforeSend: function() {},
		...
		function operation_service_group (id) {
			op_type = "delete";
			swal({
				title: "Are you sure?",
				...
				$.ajax({
					type: 'POST',
					url: site_url + 'admin/Operations/delete_service_group/' + encodeURIComponent(id),
				...
				swal("Deleted!", "Service group has been deleted!", "success");
			});
		}
