      ...
      <div class="page-content">
        <div class="panel">
          ...
          <div class="panel-heading">
            <h1 class="panel-title">Pre Gst Manager</h1>
          ...
          <div id="contactsContent" class="page-content" data-plugin="selectable">
             ...
             <form autocomplete="false" method="post" action="">
              <div class="row mb-10" style="margin-left:5px;">
                ...
                <form id="frm_customer" name="frm_customer" action="<?php echo base_url('admin/reports/pre_gst_management');?>" method="post">
                          ...
                          <table id="Manager" class="table  table-hover  table-striped w-full" data-plugin="">
                            <thead>
                              <th class="dark-background-heading">Locked On </th>
                               ...
                               <th class="dark-background-heading">Others</th>
                              <th class="dark-background-heading">pre</th>
                            ...
                            <tbody>
                              ...
                              foreach ($gst_management as $key => $value) { 
                                 $totaltax=   $tax_service_percent['tax_service_percent']/100*$value['total'];

                                 $netamount=$value['total']- $totaltax;
                              ...
                              <td><?=$netamount;?></td>
                               <td><?=$totaltax; ?></td>
                                <td><?=$value['total'];?></td>
                              <td>  <a href="<?=(base_url($value['pdf_id']))?>" target="_blank" class="btn btn-primary waves-effect waves-classic" title="Sample File" download><i class="icon md-upload" aria-hidden="true"></i></a> </td>
                              <td><button type="button" data-target="#exampleNiftyFadeScale_<?=$value['id']?>" data-toggle="modal" class="btn btn-info">Email</button></td>
                        ...
                        <div class="modal-dialog modal-simple">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">Email address to send Report to</h4>
                            </div>
                            <form method="post" action="<?php echo base_url('admin/reports/send_mail_management');?>">
