...
<body class="animsition app-contacts page-aside-left">
  ...
  <div class="page">
    ...
    <div class="page-main">
                ...
                <form id="frm_customer" name="frm_customer" action="" method="post">
                   <table id="example" class="table table-hover  table-striped w-full" data-plugin="">
                    ...
                    <tbody>        <?php  $all_total= 0;
                                   ...
                                   // print_r($invoice_services);
                                    foreach ($invoice_services as $key => $value):
                                        
                                         
                                        
                                     ?>
                                       <?php $to_date= isset($to_date) ?$to_date:'' ?>
                                          <?php $from_date= isset($from_date)?$from_date:'' ?>
                                          <?php 
                    ...
                    $all_productAmount+=$productAmount;                                
										...
										$total_tax_amount = getServiceTax($exactnetamount,$tax_percent,$tax_type);
      ...
      <div class="modal fade modal-fade-in-scale-up" id="exampleFillIn_<?php echo $value['staff_id']; ?>" aria-hidden="true"
    ...
    <div class="modal-dialog modal-simple">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <!-- <h4 class="modal-title"><?= getStaffName($value['staff_id']); ?></h4> -->
        </div>
        <form method="post" action="<?= base_url()?>admin/product/stockin">
          <div class="modal-body">
          <div id="chartContainer<?=$value['staff_id']?>" style="height: 400px; width: 100%;"></div> 
          </div>
...
function getPieChart (staff_id,staff_name,service_amount,RefundAmount,discount,voucher,productAmount) { 
  ...
  var chart = new CanvasJS.Chart("chartContainer"+staff_id,
  {
    //theme: "light2",
    title:{
      text: "Sale Staff For :"+staff_name
    },    
    data: [
    {       
      type: "pie",
     ...
     // yValueFormatString: "#,##0,,.## Million",
      ...
      dataPoints: [
        ...
        {  y: service_amount, indexLabel: "Services" },     
        {  y: discount, indexLabel: "Discount" },
        {  y: voucher, indexLabel: "Voucher"},       
        {  y: productAmount, indexLabel: "Product"},
        {  y: RefundAmount, indexLabel: "Refund" },
