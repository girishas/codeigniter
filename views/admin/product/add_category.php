          ...
          <div class="col-md-12">
            ...
            <div class="panel">
			  ...
			  <div class="page-header">
				  ...
				  <div class="page-header-actions"><h3 class="panel-title">Add Product Category</h3></div>
				</div>
                 ...
                 <input type="hidden" name="action" value="save"> 
				  ...
				  <div class="form-group  row" data-plugin="formMaterial">
                    <div class="col-md-6">
                      ...
                      <input type="text" name="category_name" id="category_name" class="form-control" value="<?php if(isset($category_name)) echo $category_name;?>">
           ...
           <div class="form-group  row" data-plugin="formMaterial">
                    <div class="col-md-6">
                      <label class="form-control-label" for="inputGrid1">Category Code</label>
                      <input type="text" name="category_code" id="category_code" class="form-control" value="<?php if(isset($category_code)) echo $category_code;?>">
					  <div class="admin_content_error"><?php echo form_error('category_code'); ?></div>
                    </div>
                  </div>
				  <div class="form-group  row" data-plugin="formMaterial">
                    <div class="col-md-6">
