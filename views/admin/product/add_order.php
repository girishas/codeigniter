							...
							<div class="col-md-6">
								...
								<span id="content_supplier_id">
									<select class="form-control" name="supplier_id" id="supplier_id" onChange="get_supplier_data(this.value);">
										...
										<option value="s<?php echo $supplier['id'];?>" <?php if(isset($supplier_id) && $supplier_id==$supplier['id']) echo "selected"; ?>><?php echo $supplier['first_name'].' '.$supplier['last_name'].' ('.$supplier['supplier_company_name'].')';?></option>
										<?php } } ?>
										 </optgroup>
						...
						<div id="contactsContent" class="page-content page-content-table" data-plugin="selectable">
							...
							<div class="input-group input-group-icon">
								...
								<div class="input-group-append">
								 ...
								 <span class="input-group-text">
										<a  onclick="getwarehouseDetail()"><i class="icon md-search" aria-hidden="true"></i></a>
									</span> 

									<!-- <span class="input-group-text">
										<a href="javascript:void(0);" data-target="#searchProducts" data-toggle="modal" onclick="getwarehouseDetail()"><i class="icon md-search" aria-hidden="true"></i></a>
									</span>  -->
							...
							<form id="frm_records" name="frm_records" action="" method="post">
								...
								<input type="hidden" name="warehouse_id_val" id="warehouse_id_val">
								<input type="hidden" name="location_id_val" id="location_id_val">
								<input type="hidden" name="business_id_val" id="business_id_val">
								<input type="hidden" name="supplier_id_type" id="supplier_id_type">
							...
							<div>
								...
								<div class="form-group  row" data-plugin="formMaterial" id="id_submit_section" style="display:none;">
									<div class="col-md-6">
										...
										&nbsp;&nbsp;
										<a href="javascript:void(0);" id="draft" onClick="return submit_order('draft');" class="btn btn-success"> Save and Process Later 
</a>
									</div>
								</div>
							</div><br>
		...
		<div class="example-grid">
		 <div  class="row">
		  ...
		  <div  class="row" id="products_listing">
		  	<!-- <div  class="warehouseDetailBody"> </div> -->
