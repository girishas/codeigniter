			...
			<div class="page-content">
				<div class="panel panel-bordered">
					...
					<div id="contactsContent" class="page-content page-content-table" data-plugin="selectable">
						...
						if($count>0){?> 
				        <!-- Contacts -->
				        <form id="frm_customer" name="frm_customer" action="<?php echo base_url('admin/product/index');?>" method="post">
				        	<div class="form-group" style="width:30%;margin-left: 16px;margin-bottom: 0px;">
									    <input autocomplete="off" type="text" name="product_search" class="form-control" id="email" placeholder="Search Product">
									</div>
									</form>
				...
				$jq(document).ready(function(){
					if($jq('#product_search').length)
					{
						$jq("#product_search").suggestion({
							url:base_url + "admin/product/index?chars=",
							minChars:2,
							width:200,
						});
					}
