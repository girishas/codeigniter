...
<body class="animsition">
    ...
    <div class="page-content">
      <div class="panel">
        ...
        <div class="page-header">
          <h1 class="page-title">Pre GST Setting</h1>
        ...
        <div class="page-content container-fluid">
          <div class="row">
            <div class="col-md-12">
              <!-- Panel Static Labels -->
              <form autocomplete="off" method="post" action="<?php echo base_url(); ?>admin/product/pre_gst_settings">
  ...
  <script type="text/javascript">
    function getdata(id){    
      window.location.href=site_url+"admin/product/pre_gst_settings/"+id;
    }
  </script>