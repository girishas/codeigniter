        ...
        <div class="panel">
          ...
          <div class="page-header">
            ...
            <?php if($admin_session['role'] == 'owner'){?>
                <div class="page-header-actions"><a href="javascript:void(0);"><button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#myModalSupplier">Add Supplier</button></a></div>
              </div>
            <?php } ?>
             <?php if($admin_session['role'] == 'business_owner'){?>
                    <div class="page-header-actions"><a href="<?php echo base_url('admin/product/add_supplier');?>"><button type="button" class="btn btn-block btn-primary">Add Supplier</button></a></div>
            ...
            <table id="example" class="table table-hover  table-striped w-full" data-plugin="">
              <thead>
                <tr>
                  ...
                  <th class=" dark-background-heading" >Supplier Name</th>
                  <th class=" dark-background-heading" >Company Name</th>
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row['id']; ?>">
                  ...
                  <td ><?php echo $row['supplier_company_name'];?></td>
                  ...
                  <td >
                    <div class="btn-group dropdown">
                      ...
                      <div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
                        <a class="dropdown-item" href="javascript:void(0)" onClick="operation_supplier('<?php echo $row['id']; ?>','active')"role="menuitem"><i class="icon md-check" aria-hidden="true"></i>Active</a>
                        <a class="dropdown-item" href="javascript:void(0)" onClick="operation_supplier('<?php echo $row['id']; ?>','inactive')" role="menuitem"><i class="icon md-pause" aria-hidden="true"></i>Inactive</a>
                     
                        <a class="dropdown-item" href="<?php echo base_url('admin/product/edit_supplier/'.$row['id']);?>" role="menuitem"><i class="icon md-edit" aria-hidden="true"></i>Edit</a>
                     
                        <!-- <a class="dropdown-item" href="javascript:void(0)" onClick="operation_supplier('<?php echo $row['id']; ?>','delete')" role="menuitem"><i class="icon md-delete" aria-hidden="true"></i>Delete</a> -->
                      </div>
                    </div>
                  </td>
                   <?php } ?>
              ...
              <?php }else{?>
              <div style="width:100%;float:left;text-align:center;">No Supplier Added</div>
            <?php }?> 
            </table>
            </form>
...
<!-- Modal -->
  ...
  function operation_supplier(id,op_type)
  {
  if (id != "") {
      swal({
            title: "Are you sure?",
          ...
          $.ajax({
              type: 'POST',
              url: site_url + 'admin/Operations/delete_supplier/' + encodeURIComponent(id),
