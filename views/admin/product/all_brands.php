  ...
  <div class="page">
    ...
    <?php } ?>
     <?php if($admin_session['role'] == 'business_owner'){?>
            <div class="page-header-actions"><a href="<?php echo base_url('admin/product/add_brand');?>"><button type="button" class="btn btn-block btn-primary">Add Brand Sub Category</button></a></div>
    ...
    <?php } ?>
          ...
          <div id="contactsContent" class="page-content page-content-table" data-plugin="selectable">
            ...
            <table id="example" class="table table-hover  table-striped w-full" data-plugin="">
              <thead>
                <tr>
                  ...
                  <th class=" dark-background-heading" >Brand Name</th>
                  <th class=" dark-background-heading" >Brand Sub Category</th>                   
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row['id']; ?>">
                  ...
                  <td>
                    ...
                    <td ><?php echo getBrandCategory($row['category_id']);?></td>
                  ...
                  <td >
                    <div class="btn-group dropdown">
                      ...
                      <div class="dropdown-menu bullet" aria-labelledby="exampleBulletDropdown1" role="menu">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url('admin/product/edit_brand/'.$row['id']);?>"><i class="icon md-edit" aria-hidden="true"></i>Edit</a>
            ...
            <?php }else{?>
            <div style="width:100%;float:left;text-align:center;">No Brand Added</div>
            <?php }?>
                      ...
                      <div class="modal-dialog modal-simple">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p>Only Owner can create Brands.</p>
                          </div>
