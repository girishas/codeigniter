 ...
 <div class="page bg-white">
      ...
      <div class="page-main">
        ...
        <div class="page-header">
          <h1 class="page-title">All Currencies</h1>
		  <div class="page-header-actions"><a href="<?php echo base_url('admin/currency/add_currency');?>"><button type="button" class="btn btn-block btn-primary">Add Currency</button></a></div>
        </div>
          ...
          <table class="table is-indent" data-plugin="animateList" data-animate="fade" data-child="tr"
            ...
            <thead>
              <tr>
                ...
                <th class="cell-100 dark-background-heading" scope="col">Currency Name</th>
				<th class="cell-100 dark-background-heading" scope="col">Currency Symbol</th>
				<th class="cell-100 dark-background-heading" scope="col">Added date</th>
				<th class="cell-100 dark-background-heading" scope="col">Status</th>				
